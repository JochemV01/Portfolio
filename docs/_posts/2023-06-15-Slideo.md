...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/2aL9620FZIM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
![Personas]({{ site.url }}/assets/images/projects/fbp-personas.png)
...
![Value proposition canvas]({{ site.url }}/assets/images/projects/fbp-vpc.png)
...
![Business Model Canvas]({{ site.url }}/assets/images/projects/fbp-bmc.png)
